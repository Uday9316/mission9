...
export const dapps: Dapp[] = [
      ...
      // 11.
  {
    ...
    status: "Live on Testnet",
    onlyOnMonad: true,
    website: "https://testnet-staking.apr.io",
      ...
      // 21.
  {
    ...
    type: "App/Infra",
    categories: ["AI::Abstraction Infrastructure"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 22.
  {
    ...
    type: "App",
    categories: ["Consumer::E-commerce / Ticketing"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 23.
  {
    ...
    type: "App",
    categories: ["Consumer::Prediction Market"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 26.
  {
    ...
    type: "Infra",
    categories: ["Infra","Social","Payments"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 27.
  {
    ...
    type: "Infra",
    categories: ["Infra","Social","Prediction Market"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 30.
  {
    ...
    type: "App",
    categories: ["DeFi::DEX","DeFi::Lending","DeFi::Stablecoin","DeFi::Yield"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 35.
  {
    ...
    type: "App",
    categories: ["Payments::Onramp and Offramps"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 50.
  {
    ...
    type: "App",
    categories: ["DeFi::Launchpads"],
    status: "Live on Testnet",
    onlyOnMonad: true,
    website: "https://monad.flap.sh",
      ...
      // 57.
  {
    ...
    type: "Infra",
    categories: ["Infra::AA","Infra::Automation","Infra::RaaS (Rollup as a Service)"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 59.
  {
    ...
    type: "App",
    categories: ["AI::Agent Launchpad","AI::Consumer AI","AI::Data"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 65.
  {
    ...
    type: "Infra",
    categories: ["Infra","Other Infra","Wallet"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 69.
  {
    ...
    type: "App/Infra",
    categories: ["AI::Consumer AI","AI::Data","DeFi::RWA","Infra::Other"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 70.
  {
    ...
    type: "App",
    categories: ["DeFi::Liquid Staking"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 72.
  {
    ...
    type: "App",
    categories: ["Consumer","AI","DeFi","RWA","Other Infra"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 78.
  {
    ...
    type: "App",
    categories: ["DeFi","Other Infra","Cross-Chain"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 81.
  {
    ...
    type: "App",
    categories: ["Consumer::Betting","Consumer::Prediction Market"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 88.
  {
    ...
    type: "App/Infra",
    categories: ["Infra::Other","NFT::Infrastructure"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 92.
  {
    ...
    type: "App",
    categories: ["AI::Data","DePIN::Data Labelling"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 108.
  {
    ...
    type: "App",
    categories: ["DeFi","Other Infra","Wallet"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 118.
  {
    ...
    type: "App/Infra",
    categories: ["Infra","Other Infra","Account Abstraction"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 120.
  {
    ...
    type: "App",
    categories: ["DeFi::Prime Brokerage"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 121.
  {
    ...
    type: "Infra",
    categories: ["Infra::Other","Infra::ZK"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 130.
  {
    ...
    type: "Infra",
    categories: ["Infra","Other Infra","Oracle"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 135.
  {
    ...
    type: "App",
    categories: ["Consumer::Social","DeFi::Memecoin"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 136.
  {
    ...
    status: "Live on Testnet",
    onlyOnMonad: true,
    website: "https://www.showdown.win",
      ...
      // 138.
  {
    ...
    type: "App",
    categories: ["DeFi::RWA","DePIN::Other"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 150.
  {
    ...
    type: "Infra",
    categories: ["Infra::Developer Tooling"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 152.
  {
    ...
    type: "App",
    categories: ["DePIN::Data Collection"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 159.
  {
    ...
    type: "App",
    categories: ["DeFi::Launchpads","DeFi::Memecoin"],
    status: "Live on Testnet",
    onlyOnMonad: true,
    website: "https://xlmeme.com",
      ...
      // 162.
  {
    ...
    type: "App",
    categories: ["Consumer","Other Infra","Cross-Chain"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 165.
  {
    ...
    type: "App",
    categories: ["DeFi","Social","Betting"],
    status: "Live on Testnet",
    onlyOnMonad: true,
      ...
      // 244.
  {
    ...
    type: "App",
    categories: ["DeFi::Lending","Governance::Other","NFT::Other"],
    status: "Live on Testnet",
    onlyOnMonad: false,
      ...
      // 249.
  {
    ...
    type: "App",
    categories: ["DeFi","NFT","Governance"],
    status: "Live on Testnet",
    onlyOnMonad: false,
